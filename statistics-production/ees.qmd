...
Supporting files should be used in exceptional cases only. Wherever possible you should upload your data as data files that can then be used in the table tool.
...
# TODO! Point to the main image upload guidance
